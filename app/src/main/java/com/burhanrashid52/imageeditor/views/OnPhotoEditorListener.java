...
public interface OnPhotoEditorListener {
     ...
     * @param colorCode current color value set on view
     */
    void onEditTextChangeListener(View rootView, String text, int colorCode, Typeface typeFace, int textSize);

    /**
     * This is a callback when user adds any view on the {@link ja.burhanrashid52.photoeditor.PhotoEditorView} it can be
    ...
    /**
     * This is a callback when user remove any view on the {@link ja.burhanrashid52.photoeditor.PhotoEditorView} it happens when usually
     * undo and redo happens or text is removed
     *
     * @param numberOfAddedViews number of views currently added
     * @deprecated Use {@link ja.burhanrashid52.photoeditor.OnPhotoEditorListener#onRemoveViewListener(ViewType, int)} instead
     */
    @Deprecated
