package com.burhanrashid52.imageeditor.stickers;
...
public class StickerAdapters extends RecyclerView.Adapter<StickerAdapters.ViewHolder> {
    ...
    public StickerAdapters(StickerBSFragment.StickerListener filterListener) {
        mStickerListener = filterListener;
        setupFilters();
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.imgSticker.setImageBitmap(fromAsset);
